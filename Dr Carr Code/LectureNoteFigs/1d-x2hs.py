...
ax.arrow(0, 0, 0.5, 0.0, head_width=0.05, head_length=0.1, fc='k', ec='k')
ax.arrow(-1, 0, 0.5, 0.0, head_width=0.05, head_length=0.1, fc='k', ec='k')

ax.set_title("$\dot{x}=x^2$ : half stable",fontsize=32)

fig.savefig("1d-x2hs.pdf")
plt.show()
