...
add_arrow(circle_top,direction='left')
circle_bottom=ax.plot(x2, y2,color='royalblue')[0]
add_arrow(circle_bottom,direction='right')
add_arrow(circle_bottom,direction='right',position=0.98)
add_arrow(circle_bottom,direction='right',position=-0.95)
...
ax.plot(+0.707,0.707,'bo',markersize=15)
ax.plot(-0.707,0.707,'bo',fillstyle='none',markersize=15)
