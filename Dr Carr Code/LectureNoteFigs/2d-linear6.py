...
# A stable spiral fixed point - use this and plot arrows backwards
...
add_arrow(flow1,position=1,direction='left')
...
states1=odeint(f,initial1,t)
flow1=ax.plot(states1[:,0],states1[:,1],color='royalblue')[0]
add_arrow(flow1,position=0.9,direction='left')
...
ax.set_title(r"Unstable Spiral",fontsize=16)

fig.savefig("2d-linear6.pdf")
plt.show()
