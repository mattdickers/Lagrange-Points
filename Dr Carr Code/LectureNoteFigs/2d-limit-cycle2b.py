...
t=np.arange(0.0,6.3,0.0001)    # time steps
tu=np.arange(0.0,1.7,0.0001)    # time steps for unstable
...
flow1=ax.plot(states1[:,0],states1[:,1],color='royalblue',linestyle='--')[0]
add_arrow(flow1,position=-0.5)

initial1=[1.01,0]
states1=odeint(f,initial1,tu)
flow1=ax.plot(states1[:,0],states1[:,1],color='royalblue')[0]
add_arrow(flow1,position=0.1)
...
fig.savefig("2d-limit-cycle2b.pdf")
plt.show()
