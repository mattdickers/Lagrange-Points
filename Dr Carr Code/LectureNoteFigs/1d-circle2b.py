...
add_arrow(circle_top,direction='right',position=0.6)
add_arrow(circle_top,direction='right',position=-0.5)
circle_bottom=ax.plot(x2, y2,color='royalblue')[0]
add_arrow(circle_bottom,direction='right',position=0)
...
plt.text(0,1,u'\u25D0',size=18,ha='center',va='center',rotation=180)
